...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class Simulation {
      ...
      advection!: Advection; externalForce!: ExternalForce; viscousPass!: Viscous; divergence!: Divergence; poisson!: Poisson; pressure!: Pressure;
    ...
    class WebGLManager {
      props: any; lastUserInteraction = performance.now(); autoDriver: AutoDriver;
